...
//Part 2: Key Handler Functions
//Function that is going to be used as the HandlerKeys for the Q2 and the canvas object for it, this function function
//adds the necesary code to handler the up and down button as action, and handlers them,
//adds movement only when inSpace is false
...
//Part 3: Key Handler Function
//Function that is going to be used as the HandlerKeys for Q3 and the canvas object for it, it does the same functionallity as part2HandlerKeys, and it handlers when the parameter in space is true.
//adds movement when the parameter inSpace is true
